...
// TODO Auto-generated method stub
        ...
        if (savedInstanceState != null) {
            ...
            answer5.setChecked(savedInstanceState.getBoolean(BUTTON5CORRECT_CHECKED_KEY));
    ...
    private void checkAnswersEtc() {
        ...
        if (checkAnswer1.equals(getText(R.string.html_q1_answer1)) || checkAnswer1.equals(getText(R.string.html_q1_answer2)) || checkAnswer1.equals(getText(R.string.html_q1_answer1) + " ") || checkAnswer1.equals(getText(R.string.html_q1_answer2) + " ")) {
        ...
        rightAnswer.setText(R.string.html_q1_correct); // correct answer of 1st question is displayed after finish button is clicked.
        ...
        //check whether the correct options for 4th question are selected (2nd, 3rd, 4th and 5th checkboxes must be selected for correct answer):
